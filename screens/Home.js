      ...
      />
      {
        loading ? (
          <View className="flex-1 flex-row justify-center items-center">
            <Progress.CircleSnail thickness={10} size={140} color="#d6b709" />
          </View>
        ) : (
          <SafeAreaView className="flex flex-1">
                      ...
                      locations.map((location, index) => {
                        ...
                        return (
                          ...
                          >
                            ...
                            <Text className="text-zinc-700 text-lg ml-2">{location?.name}, {location?.region}, {location.country}</Text>
                          </TouchableOpacity>
                        )
                      })
                    }
            ...
            <View className="mx-4 flex justify-around flex-1 mb-2">
              ...
              <Text className="text-white text-center text-2xl font-bold">
                {location?.name},&nbsp;
                <Text className="text-xl font-semibold text-gray-300">{location?.country}</Text>
              </Text>
              {/* weather icon */}
